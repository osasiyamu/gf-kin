  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1598901986949-f593ff2a31a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWxsbmVzcyUyMHRoZXJhcHklMjBtYXNzYWdlfGVufDF8fHx8MTc2NDc3Njk5NHww&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-emerald-400 rounded-full opacity-20 blur-2xl"></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-slate-900 mb-4">Featured Services</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-slate-900 mb-4">Client Testimonials</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-slate-900 mb-4">Share Your Experience</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Share your experience with GF-Kin..."
                  rows={4}
                  required
                />
              </div>
